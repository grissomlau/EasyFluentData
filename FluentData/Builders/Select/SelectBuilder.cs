...
namespace FluentData
{
    internal class SelectBuilder<TEntity> : ISelectBuilder<TEntity>
    {
        ...
        //dh 2015-02-09
        public ISelectBuilder<TEntity> RowNumberOrderBy(string sql) {
            Data.RowNumberOrderBy = sql;
            return this;
        }
        ...
        public ISelectBuilder<TEntity> Distinct() {
            Data.Distinct = "distinct";
            return this;
        }

        public ISelectBuilder<TEntity> FoundRows() {
            Data.HasFoundRows = true;
            return this;
        }
