...
namespace FluentData
{
    internal class ActionsHandler
    {
        ...
        internal void AddWhereAction(string where) {
            _data.AdditionalWhere.Append(where);
        }
        internal void AddWhereParamAction(string paramName, object value) {
            ParameterAction(paramName, value, DataTypes.Object, ParameterDirection.Input, 0);
        }
    }
}
